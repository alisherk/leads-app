...
function LeadList() {
  ...
  const searchStringOnChange = React.useCallback(({ target: { value: searchString } }) => {
    setState(oldState => ({
      ...oldState,
      searchString,
    }));
  ...
  const selectedStatusOnChange = React.useCallback(({ target: { value: selectedStatus } }) => {
    setState(oldState => ({
      ...oldState,
      selectedStatus,
    }));
  ...
  const setFilter = React.useCallback(() => {
    setState(oldState => {
      ...
      const selectedStatus = oldState.selectedStatus !== 'all' ? oldState.selectedStatus : null;
